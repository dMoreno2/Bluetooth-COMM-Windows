...
def SendAndReceive():
    ...
    #waits 1 second before running loop that sends an listens for incommming data from client. 
    ...
    #message is printed to the scren for the user and the data is sent to be processed for storing.
